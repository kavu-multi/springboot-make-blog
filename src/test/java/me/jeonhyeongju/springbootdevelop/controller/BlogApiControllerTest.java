...
class BlogApiControllerTest {
    ...
    @DisplayName("addArticle : 블로그 글 post")
    @Test
    public void addArticle() throws Exception {
        final String url = "/api/articles";
        final String title = "title";
        final String content = "content";
        final AddArticleRequest userRequest = new AddArticleRequest(title, content); // DTO부분
    ...
    @DisplayName("findAllArticles : 블로그 글 목록 조회 Sucess")
    @Test
    ...
    @DisplayName("deleteArticle : 블로그 글 삭제 Sucess")
    @Test
